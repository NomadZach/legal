...
Use the app for its intended purpose: saving and mapping places you care
about. You agree not to:

- Scrape, crawl, or bulk-extract data from the app or its services
- Abuse, overload, reverse-engineer, or interfere with the app or the
  third-party services it relies on (e.g. geocoding, platform lookup
  endpoints)
- Use the app to violate another platform's terms or another person's
  rights
- Upload or share unlawful, infringing, or harmful content

We may suspend access for abuse.

## 6. Your content and third-party links

You keep ownership of the places, captions, and profile details you add. If
you have an account, you allow us to store, back up, and display that content
back to you so the app can work and sync across your devices. You're
